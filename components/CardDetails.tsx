          ...
          p-4 text-center'>
            ...
            >
              <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh]
                ...
                {/* CLOSE BUTTON */}
                <button type="button" onClick={closeModal} className='absolute top-2
                ...
                <div className='flex-1 flex flex-col gap-3'>
                  <div className='relative w-full h-40 bg-pattern
                    ...
                    <Image src={generateImageUrl(car, 'angle')} alt='car model'
                      fill priority className='object-contain'/>
                  </div>
                  <div className='flex gap-3'>
                    <div className='flex-1 relative w-full h-24 
                    bg-primary-blue-100 rounded-lg'>
                      <Image src={generateImageUrl(car, '29')} alt='car model'
                        fill priority className='object-contain'/>
                    </div>
                    <div className='flex-1 relative w-full h-24 
                    bg-primary-blue-100 rounded-lg'>
                      <Image src={generateImageUrl(car, '34')} alt='car model'
                        fill priority className='object-contain'/>
                    </div>
                    <div className='flex-1 relative w-full h-24 
                    bg-primary-blue-100 rounded-lg'>
                      <Image src={generateImageUrl(car, '13')} alt='car model'
                        fill priority className='object-contain'/>
                    </div>
                  </div>
                </div>
                ...
                <div className='flex-1 flex flex-col gap-2'>
                  ...
                  <div className='mt-3 flex flex-wrap gap-4'>
                    {Object.entries(car).map(([key, value]) => (
                      <div className='flex justify-between gap-5 w-full text-right capitalize' key={key}>
